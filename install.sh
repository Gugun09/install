...
echo "clear" >> .bashrc
echo 'echo -e ""' >> .bashrc
echo 'echo -e "   ______                                           "' >> .bashrc
echo 'echo -e "  /      \                                          "' >> .bashrc
echo 'echo -e " /$$$$$$  | __    __   ______   __    __  _______   "' >> .bashrc
echo 'echo -e " $$ | _$$/ /  |  /  | /      \ /  |  /  |/       \  "' >> .bashrc
echo 'echo -e " $$ |/    |$$ |  $$ |/$$$$$$  |$$ |  $$ |$$$$$$$  | "' >> .bashrc
echo 'echo -e " $$ |$$$$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ | "' >> .bashrc
echo 'echo -e " $$ \__$$ |$$ \__$$ |$$ \__$$ |$$ \__$$ |$$ |  $$ | "' >> .bashrc
echo 'echo -e " $$    $$/ $$    $$/ $$    $$ |$$    $$/ $$ |  $$ | "' >> .bashrc
echo 'echo -e "  $$$$$$/   $$$$$$/   $$$$$$$ | $$$$$$/  $$/   $$/  "' >> .bashrc
...
# server settings
cd /etc/openvpn/
wget -O /etc/openvpn/server.conf "https://raw.githubusercontent.com/gugun09/install/master/server.conf"
...
wget -O /etc/network/if-up.d/iptables "https://raw.githubusercontent.com/gugun09/install/master/iptables"
...
# openvpn config
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/gugun09/install/master/client.conf"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/gugun09/install/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
...
sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 234 -p 567 -p 777"/g' /etc/default/dropbear
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/gugun09/install/master/squid3.conf"
...
cd /etc/stunnel/
wget -O /etc/stunnel/ssl.conf "https://raw.githubusercontent.com/gugun09/install/master/ssl.conf"
...
wget https://raw.githubusercontent.com/gugun09/install/master/ddos-deflate-master.zip
...
# banner /etc/bnr
wget -O /etc/bnr "https://raw.githubusercontent.com/gugun09/install/master/bnr"
...
# download script
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/gugun09/install/master/menu.sh"
wget -O edit "https://raw.githubusercontent.com/gugun09/install/master/edit-ports.sh"
wget -O edit-dropbear "https://raw.githubusercontent.com/gugun09/install/master/edit-dropbear.sh"
wget -O edit-openssh "https://raw.githubusercontent.com/gugun09/install/master/edit-openssh.sh"
wget -O edit-openvpn "https://raw.githubusercontent.com/gugun09/install/master/edit-openvpn.sh"
wget -O edit-squid3 "https://raw.githubusercontent.com/gugun09/install/master/edit-squid3.sh"
wget -O edit-stunnel4 "https://raw.githubusercontent.com/gugun09/install/master/edit-stunnel4.sh"
wget -O show-ports "https://raw.githubusercontent.com/gugun09/install/master/show-ports.sh"
...
wget -O info "https://raw.githubusercontent.com/gugun09/install/master/info.sh"
wget -O about "https://raw.githubusercontent.com/gugun09/install/master/about.sh"
